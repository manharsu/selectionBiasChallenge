...
Here is the complete four-panel statistics meme demonstrating selection bias:

```{python}
#| label: final-meme-display
#| echo: false
#| fig-cap: "Statistics meme demonstrating selection bias"
#| fig-width: 12
#| fig-height: 3
